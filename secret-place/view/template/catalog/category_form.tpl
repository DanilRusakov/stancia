            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-sm-10">
                      <textarea name="tab_review" rows="5" placeholder="<? echo $entry_tab_review; ?>" id="input-tab_review" class="form-control"><? echo isset($tab_review) ? $tab_review : ''; ?></textarea>
                    </div>
                  </div>
...
<?php if ($ckeditor) { ?>
ckeditorInit('input-tab_review', '<?php echo $token; ?>');
<?php } else { ?>
$('#input-tab_review').summernote({
  height: 300,
    lang:'<?php echo $lang; ?>'
});
<?php } ?>
