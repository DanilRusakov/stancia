                ...
                <tr>
                  ...
                  <td class="text-left">
                    ...
                    <?php if ($product['meta_title']) { ?>
                        <span>Meta Title: </span> <?=$product['meta_title']?> <br>
                    <?php } ?>
                    <?php if ($product['meta_h1']) { ?>
                        <span>Meta h1: </span> <?=$product['meta_h1']?> <br>
                    <?php } ?>
                    <?php if ($product['meta_description']) { ?>
                        <span>Meta description: </span> <?=$product['meta_description']?> <br>
                    <?php } ?>
                    <?php if ($product['meta_keyword']) { ?>
                        <span>Meta keyword: </span> <?=$product['meta_keyword']?> <br>
                    <?php } ?>
