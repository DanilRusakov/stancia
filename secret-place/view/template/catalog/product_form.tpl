...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <?php if (isset($_SESSION['default']['success']) && !$error_warning) { ?>
      <div class="alert alert-success"><i class="fa fa-check-circle"></i> <?php echo $_SESSION['default']['success']; ?>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <?php } ?>
                 <!-- Addititonal information -->
                  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-additional_information"><? echo $entry_additional_information; ?></label>
                  <div class="col-sm-10">
                    <textarea name="additional_information" value="<? echo $additional_information; ?>" placeholder="<? echo $entry_additional_information; ?>" id="input-additional_information" class="form-control" ><? echo isset($additional_information) ? $additional_information : ''; ?></textarea>
                  </div>
                </div>
                <!-- ///Addititonal information -->
                <!-- Tab review -->
                  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tab_review"><? echo $entry_tab_review; ?></label>
                  <div class="col-sm-10">
                    <textarea name="tab_review" value="<? echo $tab_review; ?>" placeholder="<? echo $entry_tab_review; ?>" id="input-tab_review" class="form-control" ><? echo isset($tab_review) ? $tab_review : ''; ?></textarea>
                  </div>
                </div>
                <!-- ///Tab review -->
              </div>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-image">Image Title</label>
                <div class="col-sm-10">
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group">
                    <span class="input-group-addon" data-toggle="tooltip" data-title="<?=$language['name']?>" data-original-title="" title=""><img src="view/image/flags/<?php echo $language['image']; ?>"></span>
                    <input type="text" name="product_description[<?=$language['language_id']?>][title_text]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['title_text'] : ''; ?>" class="form-control">
                  </div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-image">Image Alternative Text</label>
                <div class="col-sm-10">
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group">
                    <span class="input-group-addon" data-toggle="tooltip" data-title="<?=$language['name']?>" data-original-title="" title=""><img src="view/image/flags/<?php echo $language['image']; ?>"></span>
                    <input type="text" name="product_description[<?=$language['language_id']?>][alt_text]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['alt_text'] : ''; ?>" class="form-control">
                  </div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td class="text-left">Image Title
                    </td>
                    <td class="text-left">Image Alternative Text
                    </td>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-left">
                      ...
                      <div>
                        <div class="input-group">
                          <span class="input-group-addon" data-toggle="tooltip" data-title="<?=$language['name']?>" data-original-title="" title=""><img src="view/image/flags/<?php echo $language['image']; ?>"></span>
                          <input type="text" name="product_image[<?php echo $image_row; ?>][descriptions][<?=$language['language_id']?>][title_text]"
                                 value="<?php echo isset($product_image['descriptions'][$language['language_id']]) ? $product_image['descriptions'][$language['language_id']]['title_text'] : ''; ?>" class="form-control">
                        </div>
                      </div>
                      <?php } ?>
                    ...
                    <td class="text-left">
                      ...
                      <div>
                        <div class="input-group">
                          <span class="input-group-addon" data-toggle="tooltip" data-title="<?=$language['name']?>" data-original-title="" title=""><img src="view/image/flags/<?=$language['image']?>"></span>
                          <input type="text" name="product_image[<?php echo $image_row; ?>][descriptions][<?=$language['language_id']?>][alt_text]"
                                 value="<?php echo isset($product_image['descriptions'][$language['language_id']]) ? $product_image['descriptions'][$language['language_id']]['alt_text'] : ''; ?>" class="form-control">
                        </div>
                      </div>
                      <?php } ?>
                    ...
                    <td class="text-right">
                      <input type="text" name="product_image[<?php echo $image_row; ?>][sort_order]" style="min-width:65px" value="<?php echo $product_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control">
                    </td>
                    <td class="text-left">
                      <button type="button" onclick="$('#image-row<?php echo $image_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Remove"><i class="fa fa-minus-circle"></i>
                      </button>
                    </td>
...
var image_row = <?php echo $image_row; ?>;
      ...
      function addImage() {
          html  =
              ['<tr id="image-row' + image_row + '">',
                  '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="http://custom-image-titles.opencart.ee/image/cache/no_image-100x100.png" alt="" title="" data-placeholder="http://custom-image-titles.opencart.ee/image/cache/no_image-100x100.png" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>',
                  '  <td class="text-left">',
              <?php foreach ($languages as $language) { ?>
              '    <div>',
                  '      <div class="input-group">',
                  '        <span class="input-group-addon" data-toggle="tooltip" data-title="<?=$language["name"]?>"><img src="view/image/flags/<?=$language["image"]?>" /></span>',
              '        <input type="text" name="product_image[' + image_row + '][descriptions][<?=$language["language_id"]?>][title_text]" value="" class="form-control" />',
                  '      </div>',
                  '    </div>',
          <?php } ?>
      ...
      <?php foreach ($languages as $language) { ?>
              '    <div>',
                  '      <div class="input-group">',
                  '        <span class="input-group-addon" data-toggle="tooltip" data-title="<?=$language["name"]?>"><img src="view/image/flags/<?=$language["image"]?>" /></span>',
              '        <input type="text" name="product_image[' + image_row + '][descriptions][<?=$language["language_id"]?>][alt_text]" value="" class="form-control" />',
                  '      </div>',
                  '    </div>',
          <?php } ?>

          '  </td>',
          '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="0" placeholder="Sort Order" class="form-control" style="min-width:65px" /></td>',
          '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + image_row  + '\').remove();" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>',
              '</tr>'
      ].join('\n');
