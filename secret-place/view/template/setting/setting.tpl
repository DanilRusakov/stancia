        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                 <label class="col-sm-2 control-label" for="input_delivery_receipt"><? echo $entry_delivery_receipt;  ?></label>
                 <div class="col-sm-10">
                  <textarea  name="config_delivery_receipt" id="input_delivery_receipt" ><? echo $delivery_receipt;?></textarea>
                </div>
...
$(document).ready(function() {
  $('#input-contacts').summernote({
      lang: 'ru-RU',
      height: 400
  });
  $('#input_delivery_receipt').summernote({
      lang: 'ru-RU',
      height: 400
  });
});
