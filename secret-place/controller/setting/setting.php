...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_delivery_receipt'] = $this->language->get('entry_delivery_receipt');
		...
		if (isset($this->request->post['delivery_receipt'])) {
			$data['delivery_receipt'] = $this->request->post['delivery_receipt'];
		} else {
			$data['delivery_receipt'] = $this->config->get('config_delivery_receipt');
		}
