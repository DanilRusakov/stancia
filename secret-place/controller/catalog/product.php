...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_tab_review'] = $this->language->get('entry_tab_review');
		...
		if (isset($this->request->post['additional_information'])) {
			$data['additional_information'] = $this->request->post['additional_information'];
		} elseif (!empty($product_info)) {
			$data['additional_information'] = $product_info['additional_information'];

		} else {
			$data['additional_information'] = '';
		}

		if (isset($this->request->post['tab_review'])) {
			$data['tab_review'] = $this->request->post['tab_review'];
		} elseif (!empty($product_info)) {
			$data['tab_review'] = $product_info['tab_review'];

		} else {
			$data['tab_review'] = '';
		}

		// echo $data['additional_information']; die;
		...
		foreach ($product_images as $product_image) {
			...
			$data['product_images'][] = array(
                ...
                'descriptions' => ($product_image['descriptions']) ? json_decode($product_image['descriptions'], true) : array()
			);
		}
