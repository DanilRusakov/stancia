...
<div class="contact-page">
     ...
     <?php } ?>
      ...
      <? if (isset($contacts_informatioin)) {
          echo  html_entity_decode($contacts_informatioin);
        }
      ?>
     <?php if ($geocode) { ?>
    ...
    <script type="text/javascript">
        ...
        function init(){ 
            ...
            myPlacemark = new ymaps.Placemark([<?php echo $geocode; ?>], {
                preset: 'twirl#redIcon',
                hintContent: 'Станция вейпшоп'
    ...
    <div id="map" style="width: 870px; height: 470px" ></div>
    <?php } ?>

    <?php /* ?>
    <div class="how-to-contact">
        <div class="row">
            <div class="contact-way col-lg-6 col-xs-12">
