						...
						<div class="header-top-inner">
						     <div class="row">
						          <div class="hidden-xs col-xs-12 col-sm-6 col-md-6 col-lg-6">
						               <div class="welcome-user hidden-xs"><?php if($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) )); } else { echo 'Hello guys ! Welcome to Logancee Store !'; } ?></div>
						          </div>
