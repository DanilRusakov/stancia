...
<head>
	...
	<meta name="yandex-verification" content="83c145c2cf9f6d1a" />
	<meta name="yandex-verification" content="74a6c14e850b7974" />
	...
	<?php $lista_plikow = array(
			...
			'catalog/view/theme/'.$config->get( 'config_template' ).'/css/eleganticons.css',
			'catalog/view/theme/'.$config->get( 'config_template' ).'/css/simple-line-icons.css',
	...
	// Filter product
	$lista_plikow[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/css/filter_product.css';
