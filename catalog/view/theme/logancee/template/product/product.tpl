...
<div itemscope itemtype="http://schema.org/Product">
        ...
        <div class="row">
            ...
            <div class="col-sm-<?php if($theme_options->get( 'custom_block', 'product_page', $config->get( 'config_language_id' ), 'status' ) == 1 || count($product_custom_block)) { echo 9; } else { echo 12; } ?>">
			    ...
			    if ($theme_options->get( 'product_image_size' ) == 1) {
                    ...
                    ?>
                    <div class="col-sm-<?php echo $image_grid / 2; ?> popup-gallery">
                        <?php
			      $product_image_top = $modules->getModules('product_image_top');
                        ...
                        <div class="row">
                            ...
                            <?php if (($images || $theme_options->get( 'product_image_zoom' ) != 2) && $theme_options->get( 'position_image_additional' ) != 2) { ?>
                            <div class="col-sm-12" style="margin-left: 6px; margin-top: 40px;">
                                <div class=""><!-- overflow-thumbnails-carousel -->
                                    <div class="thumbnails-carousel ">
                                        <?php if($theme_options->get( 'product_image_zoom' ) != 2 && $thumb) { ?>
                                        <div class="my_item"><a href="<?php echo $popup; ?>" class="popup-image" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>"><img src="<?php echo $theme_options->productImageThumb($product_id, $config->get('config_image_additional_width'), $config->get('config_image_additional_height')); ?>" title="<?php echo isset($title_text) ? $title_text : $heading_title; ?>" alt="<?php if ($customimage_show_alt) { echo isset($alt_text) ? $alt_text : $heading_title; } ?>" /></a></div>
                                        <?php } ?>

                                        <?php $i=1; foreach ($images as $image) { ?>
                                        <?if($i%3==0){echo "<br>";}?>
                                        <div class="my_item"><a href="<?php echo $image['popup']; ?>" class="popup-image" data-image="<?php echo $image['popup']; ?>" data-zoom-image="<?php echo $image['popup']; ?>"><img src="<?php echo $image['thumb']; ?>" title="<?php echo isset($image['title']) ? $image['title'] : $heading_title;  ?>" alt="<?php if ($customimage_show_alt) { echo isset($image['alt']) ? $image['alt'] : $heading_title; } ?>" /></a></div>
                                        <?php $i++;} ?>
                                    </div>
                                </div>
			      ...
			      $product_options_top = $modules->getModules('product_options_top');
			      		...
			      		if(isset($wyniki[1][0])) { echo $wyniki[1][0]; } else { echo 0; } ?></span>
                                ...
                                <div class="rating"><i class="fa fa-star<?php if($rating >= 1) { echo ' active'; } ?>"></i><i class="fa fa-star<?php if($rating >= 2) { echo ' active'; } ?>"></i><i class="fa fa-star<?php if($rating >= 3) { echo ' active'; } ?>"></i><i class="fa fa-star<?php if($rating >= 4) { echo ' active'; } ?>"></i><i class="fa fa-star<?php if($rating >= 5) { echo ' active'; } ?>"></i>
                                    <p class="rating-links">
                                        <a onclick="$('a[href=\'#tab-review\']').trigger('click'); $('html, body').animate({scrollTop:$('#tab-review').offset().top}, '500', 'swing');"><?php echo $reviews; ?></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click'); $('html, body').animate({scrollTop:$('#tab-review').offset().top}, '500', 'swing');"><?php echo $text_write; ?></a></p></div>
                            </div> -->
                            <?php } ?>
                        ...
                        <div class="description">
                            <?php if ($manufacturer) { ?>
                            <strong><?php echo $text_manufacturer; ?></strong> <a href="<?php echo $manufacturers; ?>" itemprop="brand"> <?php echo $manufacturer; ?></a> <br />
                            <?php } ?>
                            <?php if ($reward) { ?>
                            <strong><?php echo $text_reward; ?></strong> <?php echo $reward; ?><br />
                            <?php } ?>
                            <strong><?php echo $text_stock; ?></strong> 
                            <?php if ($quantity > 0) { ?>
                            <strong style="color: #a6d222;"> На складе</strong>
                            <?php } else { ?>
                                <?php if ($stock_status_id == 8) { ?>
                                <strong style="color: #ff8b0e;">Предзаказ</strong>
                                <?php } else { ?>
                        ...
                        <?php if (trim(strip_tags($additional_information))) { ?>
                            <div class="description">
                             <?php echo $additional_information; ?>
                             </div>
                        <?php } ?> 
                        <?php if (trim(strip_tags($config_delivery_receipt))) { ?>
                        <div class="description">
                             <?php echo $config_delivery_receipt; ?>
                        </div>
                        <?php } ?>
  ...
  $product_over_tabs = $modules->getModules('product_over_tabs');
    ...
    <div id="tabs" class="htabs">
        ...
        <a href="#tab-survey"><?php echo $tab_survey ?></a>
    </div>
    <?php $i = 0; foreach($tabs as $tab) { $i++;
  	$id = 'tab_'.$i;
