            ...
            <?php foreach ($products as $product) { ?>
                ...
                <tr>
                    ...
                    <td class="name">
                        ...
                        <?php if (!$product['stock'] && ($config_stock_warning || !$config_stock_checkout) && $product['stock_id']!='8') { $product_warning='1'; ?>
                            <span class="product-warning">***</span>
                        <?php } ?>
                        <?php if ($product['stock_id']=='8') { ?>
                            <span class="product-warning-pre-order">(Предзаказ)</span>
                        <?php } ?>
                        <div class="options">
                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            ...
                            <input  type="text" class="form-control" data-onchange="changeProductQuantity" name="quantity[<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1"  >
