...
<style>
    ...
    <div class="breadcrumb">
        <div class="background with-other-image">
            <div class="container">
                <ul class="new_breadcrumb" style="margin-left: 0px; padding: 5px 0px 0px 6px;">
...
<?php } ?>
            ...
            <?php if (!$cart_empty) { ?>
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right">
                        ...
                        <?php } ?>
                        <?php if (!$block_order || !$product_warning) { ?>
    ...
    <script>
        var warning = $('.product-warning').text();
        if(warning){
            $('#simplecheckout_button_confirm').remove();
             $('#simplecheckout_cart > div.table-responsive').before("<div class=\"simplecheckout-warning-block\">Товары, отмеченные ***, недоступны в нужном количестве или их нет на складе!</div>");
        }
