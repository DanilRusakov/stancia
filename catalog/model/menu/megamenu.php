     												...
     												if(isset($array['categories'][$i]['children'])) {
     													if(!empty($array['categories'][$i]['children'])) {
     													     ...
     													     if($array['submenu'] == 2 && $array['image_position'] == 4 && $image_url) {
     													          ...
     													          $width = $array['image_width'];
     													          $height = $array['image_height'];
     													          $output .= '<div class="open-categories"></div><div class="close-categories"></div><div class="clearfix categories-image-right" data-image="' . $image . '"><div class="left-categories-image-left"><a href="'.$link.'"><img src="' . $image . '" class="image-right" alt="Image"></a></div><div class="right-categories-image-left">';
     													     }
     														...
     														if($array['submenu'] == 2 && $array['image_position'] == 3 && $image_url) {
     														     $output .= '</div><div class="right-categories-image-right"><a href="'.$link.'"><img src="' . $image . '" class="image-right" alt="Image"></a></div></div>';
     														}
